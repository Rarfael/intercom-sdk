...
from projectname_sdk.core.control import IntercomControl
...
class IntercomContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, IntercomResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, IntercomResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return IntercomError(code, msg, self)
