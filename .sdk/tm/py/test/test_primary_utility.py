# Intercom SDK primary utility test
...
from projectname_sdk import IntercomSDK
from projectname_sdk.core.spec import IntercomSpec
from projectname_sdk.core.result import IntercomResult
from projectname_sdk.core.response import IntercomResponse
from projectname_sdk.core.operation import IntercomOperation
from projectname_sdk.core.error import IntercomError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import IntercomBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = IntercomSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = IntercomSDK.test(None, None)
        ...
        class TestInitFeature(IntercomBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(IntercomBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = IntercomSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = IntercomSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = IntercomSDK.test(None, setup_opts)
