...
class IntercomTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = IntercomTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = IntercomTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = IntercomTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
