...
// Intercom SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class IntercomTestFeature extends IntercomBaseFeature
{
    ...
    public function init(IntercomContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (IntercomContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (IntercomContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(IntercomContext $ctx, $op, $args): array
    {
