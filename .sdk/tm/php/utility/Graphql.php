...
class IntercomGraphql
{
    ...
    // equivalent.
    public static function body(IntercomContext $ctx): mixed
    {
    ...
    public static function errors(IntercomContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
