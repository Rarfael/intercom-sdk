...
function envOverride(m) {
    if ('TRUE' === process.env.INTERCOM_TEST_LIVE ||
        'TRUE' === process.env.INTERCOM_TEST_OVERRIDE) {
    ...
    m.INTERCOM_TEST_EXPLAIN = process.env.INTERCOM_TEST_EXPLAIN || m.INTERCOM_TEST_EXPLAIN;
    return m;
}
