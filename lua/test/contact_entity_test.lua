...
describe("ContactEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set INTERCOM_TEST_CONTACT_ENTID JSON to run live")
      return
    end
    ...
    local contact_ref01_markdef_up0_name = "email"
...
function contact_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("INTERCOM_TEST_CONTACT_ENTID")
