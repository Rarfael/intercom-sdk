...
---@param reqmatch ContactLoadMatch
---@param ctrl? table
---@return Contact
---@return string? err
function ContactEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ContactUpdateData
---@param ctrl? table
---@return Contact
---@return string? err
function ContactEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ContactRemoveMatch
---@param ctrl? table
---@return Contact
---@return string? err
function ContactEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
