# Intercom SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions IntercomSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both IntercomSDK(...) and IntercomSDK.test(...) become
#      IntercomSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "intercom_sdk"
_SDK_CLASS = "IntercomSDK"
