...
// Intercom SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (IntercomSDK::test)
...
{
    private const SDK_CLASS = 'IntercomSDK';
    ...
    private const SDK_BASE = 'intercom_sdk';
