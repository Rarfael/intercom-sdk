...
class IntercomTestRunner
{
    ...
    {
        $live = self::getenv('INTERCOM_TEST_LIVE');
        $override = self::getenv('INTERCOM_TEST_OVERRIDE');
        ...
        $explain = self::getenv('INTERCOM_TEST_EXPLAIN');
...
class_alias('IntercomTestRunner', 'Runner');
class_alias('IntercomHelpers', 'Helpers');
