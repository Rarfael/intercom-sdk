...
// Intercom SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class IntercomMakeRequest
{
    public static function call(IntercomContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new IntercomResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new IntercomResponse($fetched);
        } else {
