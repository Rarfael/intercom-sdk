...
class IntercomFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; IntercomSDK/1.0)';
    ...
    public static function call(IntercomContext $ctx, string $fullurl, array $fetchdef): array
    {
